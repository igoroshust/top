...
//     const cart = getCart();
//     const existing = cart.find(item => item.id === productId); // { id: 1, quantity: 5 }
//     if (existing) {
...
//             console.log('Элемент на удаление:', item)
//             console.log('Индекс элемента в корзине:', deleteElement)
