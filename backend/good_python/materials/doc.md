...
### Тема: функции
Операция - действие, выполняемое над данными (операндами) согласно правилам языка.
Оператор - элемент кода, обозначающий определённое действие (операцию) над данными (+, -, /, ** и тд).

### Аннотации
Не аннотировать небольшие программы, аннотировать сложные, но важна мера. Цель - упрощение восприятия текста программы.
